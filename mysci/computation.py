def compute_windchill(t, v):
    ...
    NOTE: This computation is valid only for temperature between -45F and +45F
...
def compute_dewpoint(t,h):
    ...
    Parameters:
        t: The temeprature in unites of F (float)
        h: The relateive humidity in units of % (float)
    """
